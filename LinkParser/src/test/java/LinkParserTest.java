...
public class LinkParserTest {
	...
	public class A_LocalURLTests {
		...
		public class A1_LocalValidTests {
			/**
			 * Tests a single link.
			 *
		...
		@Nested
		@TestMethodOrder(OrderAnnotation.class)
		public class A2_LocalInvalidTests {
			/**
			 * Tests a single link.
			 *
			 * @see LinkParser#getValidLinks(URL, String)
			...
			public void testJavascript() throws MalformedURLException {
				String html = "<a href=\"javascript:alert('Hello!');\">Say hello!</a>";
				testInvalid(html);
			}
			...
			public void testEmail() throws MalformedURLException {
				String html = "<a href=\"mailto:sjengle@cs.usfca.edu\">sjengle@cs.usfca.edu</a>";
				testInvalid(html);
			}
		}
		...
		@Nested
		@TestMethodOrder(OrderAnnotation.class)
		public class A3_LocalMultipleTests {
			/**
	...
	public class B_RemoteLinkTest {
		...
		@Nested
		@TestMethodOrder(OrderAnnotation.class)
		public class B1_RemoteSimpleTests {
			/**
		...
		@Nested
		@TestMethodOrder(OrderAnnotation.class)
		public class B2_RemoteRecurseTests {
			/**
			 * Tests listing links for a remote URL.
			 *
			 * @throws MalformedURLException if unable to create URLs
		...
		@Nested
		@TestMethodOrder(OrderAnnotation.class)
		public class B3_RemoteGutenTests {
			/**
			 * Tests listing links for a remote URL.
			 *
			 * @throws MalformedURLException if unable to create URLs
	...
	public static void testRemote(String url, List<URL> expected) throws MalformedURLException {
		...
		Assertions.assertTimeout(Duration.ofSeconds(30), () -> {
			...
			Assertions.assertEquals(expected, actual, () -> {
				...
				int stop = Math.max(expected.size(), actual.size());
